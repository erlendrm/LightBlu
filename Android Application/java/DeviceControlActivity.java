...
public class DeviceControlActivity extends Activity {
    ...
    public final static UUID UUID_LIGHT_STATUS =
            UUID.fromString(GattAttributes.LIGHT_STATUS);
    public static final boolean DEV_MODE = true;
    private ExpandableListView mGattServicesList;
    private BluetoothLeGatt mBluetoothLeService;
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            mBluetoothLeService = ((BluetoothLeGatt.LocalBinder) service).getService();
                ...
                public boolean onChildClick(ExpandableListView parent, View v, int groupPosition,
                    ...
                    if (mGattCharacteristics != null) {
                        ...
                        if ((charaProp & BluetoothGattCharacteristic.PROPERTY_WRITE) > 0) {
                            ...
                            if (Buffer.lysadv == 0x05)
                            {
                                write_data[0] = 0x07;
                                Buffer.lysadv = 0x07;
                            }
                            else if (Buffer.lysadv == 0x07)
                            {
                                write_data[0] = 0x05;
                                Buffer.lysadv = 0x05;
                            }
                            ...
                            System.out.println(Arrays.toString(write_data));
    ...
    private void displayData(String data) {
        ...
        if (data != null) {
            ...
            if (Buffer.lysadv == (0x0C)) {
                ab = "20%";
            }

            if (Buffer.lysadv == (0x0E)) {
                ab = "40%";
            }

            if (Buffer.lysadv == (0x10)) {
                ab = "60%";
            }

            if (Buffer.lysadv == (0x12)) {
                ab = "80%";
            }

            if (Buffer.lysadv == (0x14)) {
                ab = "100%";
            }
        }


            mDataField.setText(ab);
        }
